                ...
                <div class="row">  
                    <div class="col-md-10">
                        <div class="form-group">
                            <?= form_open('admin/announcements/types/edit/' . $typename['TypeID']); ?>
                                <label for="typename">Type : </label>
                                <p><input required class="form-control" id="typename" type="text" name="typename" value="<?= $typename['TypeName']; ?>"></p>

                                <input style="background-color:#428bca; color:white;" class="btn btn-primary" type="submit" value="Update Type">

                                <a style="margin-left:1%; background-color:#5bc0de; color:white;" class="btn btn-info" href="<?= site_url('admin/announcements/types'); ?>">Cancel</a>
                            <?= form_close(); ?>
                        </div>
                    </div>
                </div>
